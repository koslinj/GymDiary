...
const SignIn = () => {
  ...
  return (
    <View style={{ paddingTop: insets.top }} className="flex-1 justify-center bg-slate-300 px-8">
      <TextInput
      ...
      <View>
        {
          loading ? (
            ...
            <TouchableOpacity className="bg-secondary p-3 rounded-md w-48 mx-auto" onPress={handleLogin}>
              <Text className="text-xl font-poppinsBold text-center">Sign In!</Text>
            </TouchableOpacity>
          )
        }
      </View>

      <TouchableOpacity onPress={() => router.push('signUp')} className="bg-secondary/50 p-2 rounded-md mt-6 w-48 mx-auto">
